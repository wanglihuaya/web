/*! For license information please see index.bundle.64494f6f7fcfde0bc7bf.js.LICENSE.txt */
(() => {
  var e = {
      839: (e, t, n) => {
        "use strict";
        ...
        o.push([
          e.id,
          "#box{width:100px;height:200px;background-color:teal}",
          "",
        ]);
        const i = o;
      },
        ...
        !(function (t, n) {
              ...
              function (e, t) {
                E.fn[e] = function (n, r) {
                  ...
                  return (
                    ...
                    this.length > 1 &&
                      (M[e] || E.uniqueSort(o), P.test(e) && o.reverse()),
                    this.pushStack(o)
                  );
                };
              }
                  ...
                  o = {
                    ...
                    then: function (e, n, o) {
                      ...
                      return E.Deferred(function (r) {
                        t[0][3].add(a(0, r, m(o) ? o : F, r.notifyWith)),
          ...
          function Ie(e, t) {
            ...
            if (1 === t.nodeType) {
              ...
              K.hasData(e) &&
                ((i = K.access(e)), (a = E.extend({}, i)), K.set(t, a));
            }
          }
          function Fe(e, t) {
            var n = t.nodeName.toLowerCase();
          ...
          function We(e, t, n, r) {
            ...
            if (
              g ||
              (p > 1 && "string" == typeof h && !v.checkClone && He.test(h))
            )
                ...
                if ((u = !E.isEmptyObject(t)) || !E.isEmptyObject(d))
                  ...
                  d))
                    u ||
                      ...
                      g && de([e], !0),
                      p.done(function () {
                        for (r in (g || de([e]), Z.remove(e, "fxshow"), d))
                          E.style(e, r, d[r]);
                      })),
                      (u = dt(g ? v[r] : 0, r, p)),
                      r in v ||
          ...
          E.ajaxSetup({
            ...
            E.each(["top", "left"], function (e, t) {
              E.cssHooks[t] = Ve(v.pixelPosition, function (e, n) {
                if (n)
                  return (
                    (n = Xe(e, t)), $e.test(n) ? E(e).position()[t] + "px" : n
                  );
              });
            }),
      ...
      370: (e, t, n) => {
        e.exports = n.p + "images/d8dfc35a2be3847a94695c84b34c06c5.jpg";
      },
    },
    t = {};
  function n(r) {
  ...
  (n.n = (e) => {
    ...
    (() => {
      ...
      const e = { name: "Alex" },
        t = {
          fn() {
            console.log("Hello world," + e.name);
          },
        };
      var r = n(379),
        o = n.n(r),
      ...
      var s = n(755);
      s("#box").css("border", "10px solid white"),
        console.log(s("#box")),
